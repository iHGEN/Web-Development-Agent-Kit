---
name: aws
description: AWS web infrastructure integration and operational conventions.
---
...
- Use IAM roles/short-lived credentials instead of long-lived access keys where possible.
