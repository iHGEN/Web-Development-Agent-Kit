---
name: docker-volumes
description: Docker volumes, bind mounts, persistence, permissions, and backup implications.
---
...
Persistent or mounted container data.
...
- Make persistence ownership explicit.
- Do not mount broad host paths when a narrow path is sufficient.
