...
description: Database migration sequencing, compatibility windows, and deploy safety.
---
...
Schema/data migrations during releases.
...
- Prefer expand-migrate-contract for changes that must survive mixed application versions.
