...
description: Kubernetes metrics/logs/traces and workload/cluster observability.
---
...
Observing Kubernetes workloads.
...
- Correlate application telemetry with pod/deployment identity.
