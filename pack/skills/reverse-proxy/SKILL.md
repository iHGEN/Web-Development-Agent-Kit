---
name: reverse-proxy
description: Reverse proxy routing, upstreams, headers, timeouts, and trust boundaries.
---
...
- Forward only required headers and define trusted proxy behavior explicitly.
