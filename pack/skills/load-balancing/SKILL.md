---
name: load-balancing
description: Load-balancing algorithms, health, session affinity, and failure handling.
---
...
Multiple app instances/upstreams.
...
- Avoid sticky sessions when shared/session architecture can support stateless routing.
