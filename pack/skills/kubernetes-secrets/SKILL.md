...
description: Kubernetes secret delivery, external secret stores, and rotation.
---
...
- Base64 encoding is not encryption; use appropriate secret-management controls.
