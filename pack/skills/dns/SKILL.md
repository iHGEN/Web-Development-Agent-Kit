---
name: dns
description: DNS records, TTLs, cutovers, validation, and service discovery basics.
---
...
- Plan TTL changes before high-risk migrations when fast rollback is required.
