...
description: Zero/low-downtime release design and compatibility.
---
...
Availability-sensitive releases.
...
- Coordinate application, schema, queue, and cache compatibility.
