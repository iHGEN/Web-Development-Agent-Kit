...
description: Container architecture and runtime boundaries.
---
...
Containerizing or reviewing a service.
...
- Treat the container as a deployable runtime boundary, not a replacement for application architecture.
- Keep build-time and runtime dependencies separate.
