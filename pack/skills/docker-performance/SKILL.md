...
description: Container build/runtime performance and image-size optimization.
---
...
Container performance or slow builds.
...
- Measure image/build bottlenecks before introducing complexity.
- Minimize unnecessary files and runtime packages.
