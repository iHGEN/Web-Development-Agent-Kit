---
name: dockerfile
description: Dockerfile authoring, layering, build context, users, and runtime entrypoints.
---
...
- Order layers to maximize safe cache reuse.
- Use exec-form ENTRYPOINT/CMD where signal handling matters.
