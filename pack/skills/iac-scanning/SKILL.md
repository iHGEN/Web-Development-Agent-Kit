---
name: iac-scanning
description: IaC security/misconfiguration scanning.
---
...
Terraform/Kubernetes/CloudFormation-style scanning.
...
- Validate scanner findings against actual deployment context before auto-fixing.
