...
description: Container registry publishing, tags, retention, auth, and promotion.
---
...
- Use immutable release identifiers in addition to human-friendly tags.
- Separate build from environment promotion.
