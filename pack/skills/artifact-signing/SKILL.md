...
description: Artifact/container signing, verification, identity, and trust policy.
---
...
- Verification policy must be enforced at the deployment boundary to provide value.
