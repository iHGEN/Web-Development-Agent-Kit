...
description: Docker daemon/image/runtime security and least-privilege container execution.
---
...
- Prefer non-root runtime users when feasible.
- Avoid privileged mode and broad host mounts unless explicitly required.
