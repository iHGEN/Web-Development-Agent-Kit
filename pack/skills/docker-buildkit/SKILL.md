...
description: Docker BuildKit caches, mounts, secrets, and advanced build behavior.
---
...
BuildKit or optimized container builds.
...
- Use cache mounts for dependency caches when reproducibility is preserved.
- Use secret mounts instead of ARG/ENV for build secrets.
