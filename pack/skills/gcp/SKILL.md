---
name: gcp
description: Google Cloud web infrastructure integration and operational conventions.
---
...
- Use service accounts with narrow roles and workload identity where appropriate.
