...
description: Central log collection, structure, retention, search, and correlation.
---
...
- Use correlation/request identifiers where they materially improve traceability.
