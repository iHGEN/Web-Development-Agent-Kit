---
name: build-caching
description: Safe CI build/dependency caching and invalidation.
---
...
- Cache derived artifacts only with keys tied to all correctness-relevant inputs.
