---
name: service-mesh
description: Service mesh routing, mTLS, retries, policy, and observability tradeoffs.
---
...
- Do not add a service mesh for problems solvable more simply at application/ingress level.
