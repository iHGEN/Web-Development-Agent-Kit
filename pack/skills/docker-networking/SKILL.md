...
description: Docker and Compose networking, ports, DNS, and service connectivity.
---
...
Container connectivity/port issues.
...
- Prefer service DNS names inside Compose networks.
- Publish only ports that must be reachable from the host.
