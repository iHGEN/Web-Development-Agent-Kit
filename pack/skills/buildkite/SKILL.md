---
name: buildkite
description: Buildkite pipelines, agents, artifacts, secrets, and concurrency.
---
...
- Treat agent hosts as privileged infrastructure and isolate untrusted builds.
