...
description: Secret detection, revocation, rotation, and prevention.
---
...
- If a real secret leaked, remove it from use by rotation/revocation; deleting the file alone is insufficient.
