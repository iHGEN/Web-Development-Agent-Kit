---
name: caddy
description: Caddy web server/reverse proxy, TLS automation, routing, and headers.
---
...
- Preserve automatic HTTPS behavior unless requirements demand custom TLS handling.
