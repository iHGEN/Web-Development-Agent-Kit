---
name: ansible
description: Ansible inventories, roles, playbooks, idempotency, and secret handling.
---
...
- Tasks should be idempotent unless an explicit one-shot operation is intended.
