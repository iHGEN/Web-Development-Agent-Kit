...
description: Build artifact packaging, storage, retention, provenance, and promotion.
---
...
- Artifacts used for deployment should be immutable and traceable to source revision.
