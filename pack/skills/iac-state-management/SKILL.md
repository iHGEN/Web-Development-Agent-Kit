---
name: iac-state-management
description: IaC remote state, locking, access, backup, and recovery.
---
...
Terraform/OpenTofu/Pulumi state.
...
- State access should be tightly controlled because state may contain sensitive metadata.
