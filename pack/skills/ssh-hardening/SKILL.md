---
name: ssh-hardening
description: SSH access, keys, account restrictions, forwarding, and audit practices.
---
...
- Prefer key-based authentication and restrict privileged access.
