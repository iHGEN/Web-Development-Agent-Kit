...
description: Container health checks and startup/readiness behavior.
---
...
Container health or orchestration checks.
...
- Health checks should test meaningful service readiness, not only process existence.
